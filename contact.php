  ...
  <br>
	...
	<div class="formulaire">
		<form action="#" id="monForm" method="post" name="monForm" onsubmit="envoieForm()">
			<label for="champ-nom">Nom :</label> <input autofocus="" id="champ-nom" name="name" placeholder="Prénom - NOM" required="required" type="text"> <label for="champ-mail">Email :</label> <input id="champ-mail" name="mail" placeholder="Nom@Domaine.com" required="required" type="text"> <label for="objet">Objet :</label> <input name="objet" type="text"> <label for="subject">Message :</label> 
